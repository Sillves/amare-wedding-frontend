...
/**
 * Demo expenses for Emma & James's wedding
 * Total budget: ~£25,850
 */
export const DEMO_EXPENSES: WeddingExpenseDto[] = [
  {
    id: 'expense-1',
    weddingId: 'demo',
    amount: 8500,
...
/**
 * Pre-calculated expense summary for the demo wedding
 */
export const DEMO_EXPENSE_SUMMARY: WeddingExpenseSummaryDto = {
  totalAmount: DEMO_EXPENSES.reduce((sum, exp) => sum + (exp.amount ?? 0), 0),
  categoryTotals: {
    Venue: 8500,
    Catering: 7050, // 6400 + 650
    Photography: 3200,
    Decoration: 1800,
    Attire: 3300, // 2500 + 800
    Transport: 450,
    Other: 1550, // 1200 + 350
  },
